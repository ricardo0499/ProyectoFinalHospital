...
<html>
    ...
    <body>
        ...
        <div id="slideshow">
        <form action="RController?accion=insertar" method="post" autocomplete="off">
            <center><h2 style="margin-bottom: 20px;margin-left: -20px;">Escriba Los Datos</h2></center>
        <p>
             Nombre:
              <input class="form-input" id="nombre" name="nombre" type="text" required="required"/>
            </p>
            <p>Cédula:<p style="color: grey">Debe escribir el número de Cédula separado por guión (x-xxx-xxxx)</p>
            ...
            <p>Email:<p style="color: grey">Debe escribir el Email (ejemplo@ejemplo.com)</p>
