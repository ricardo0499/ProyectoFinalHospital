...
<html>
    ...
    <body>
        ...
        <form action="PacienteController?accion=verificar" method="post" autocomplete="off">
            ...
            <form action="PacienteController?accion=inicioCliente">
                <center><input class="form-btn" type="submit" value="Cancelar"/></center>
            </form>
            </div>
    </body>
    <script>
